		...
		<div class="container-fluid">
			<div class="row bootstrappieces">
					...
					<table>
						...
						<table>
							...
							<tbody>
								...
								<tr>
									<td colspan='3'>Please click the links above to display 3D
										images</td>
								</tr>
						...
						<td>
						<table>
							<tr><th>Submitted Image</th></tr>
							<tr><td style="background: white"><img src="UploadedImages/${imagebean.path }" style="width: 250px"></td></tr>
						</table></td>
				...
				<div class="col-md-2 shadowboxes">
					<table>
						<tr><th colspan="2">Legend for P-OSRA Results</th></tr>
					...
					<div style="text-align: left">For more information on how to read SMILES strings, click <a
						href='http://www.daylight.com/dayhtml/doc/theory/theory.smiles.html'>
						here</a>.<br /> <br />
						
						For more information on how
					to interpret the degrees assigned to each segment of your polymer,
					press 'Return' and click the 'Documentation' tab.
					</div>
				</div>
